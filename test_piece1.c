...
void set_up_pieces_ane() {
    pieces_ane[0] = new_piece(1,3,2,2,true,true);
    pieces_ane[1] = new_piece(1,1,2,1,true,true);
    pieces_ane[2] = new_piece(1,0,2,1,true,true);
    pieces_ane[3] = new_piece(3,0,1,1,true,true);
}
...
bool test_intersect_ane() {
    ...
    piece pb_piece3 = new_piece(1, 3, 2, 1 ,true, true);
    piece pb_piece4 = new_piece(1, 3, 1, 2 ,true, true);
